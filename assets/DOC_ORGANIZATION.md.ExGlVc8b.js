import{_ as s,c as a,o as e,ag as p}from"./chunks/framework.D8iaFA0a.js";const u=JSON.parse('{"title":"ScheduleLua Documentation Organization","description":"","frontmatter":{},"headers":[],"relativePath":"DOC_ORGANIZATION.md","filePath":"DOC_ORGANIZATION.md","lastUpdated":1746144625000}'),i={name:"DOC_ORGANIZATION.md"};function l(t,n,c,o,r,d){return e(),a("div",null,n[0]||(n[0]=[p(`<h1 id="schedulelua-documentation-organization" tabindex="-1">ScheduleLua Documentation Organization <a class="header-anchor" href="#schedulelua-documentation-organization" aria-label="Permalink to &quot;ScheduleLua Documentation Organization&quot;">​</a></h1><p>This document outlines the organization and development process for the ScheduleLua documentation. It serves as a guide for maintaining and expanding the documentation.</p><h2 id="directory-structure" tabindex="-1">Directory Structure <a class="header-anchor" href="#directory-structure" aria-label="Permalink to &quot;Directory Structure&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>docs/</span></span>
